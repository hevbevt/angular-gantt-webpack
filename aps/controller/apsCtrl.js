    ...
    constructor() {
        this.data = [
            ...
            {name: 'Milestones', height: '3em', sortable: false, classes: 'gantt-row-milestone', color: '#45607D', tasks: [
                ...
                {name: 'Shop is running',tooltips: {
                    enabled: true,
                    content: `
                        <div style="height: 100px; width: 100px;background: #777;">
                            <span style="color: red;">test</span>
                        </div>
                    `
                }, color: '#93C47D', from: new Date(2013, 10, 22, 12, 0, 0), to: new Date(2013, 11, 2, 12, 0, 0)},
